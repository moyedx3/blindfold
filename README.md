...
bundle. These results do not establish public-network or real-TEE readiness. The team's live checklist of
what is done, verified, and still open is [`docs/status.md`](docs/status.md).
